...
function buildDeltaPro(sn, name, d) {
  ...
  return `<div class="card">
    ...
    ${hasSolar?`<div class="section-title">Solar / MPPT</div><div class="stats">
      ...
      ${solarIn > 1 && !acIn && g(d,'mppt.chgType')==1 && dcBus <= solarIn*1.05 ? `<span class="stat-label">MPPT Efficiency</span><span class="stat-value" style="color:var(${dcBus/solarIn>=0.95?'--green':dcBus/solarIn>=0.85?'--yellow':'--red'})">${(dcBus/solarIn*100).toFixed(0)}%</span>
